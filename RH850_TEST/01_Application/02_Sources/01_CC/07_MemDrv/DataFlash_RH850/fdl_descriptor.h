 ...
 *********************************************************************************************************************/
    ...
    #define CPU_FREQUENCY_MHZ      64  /*CPU frenquency change in new driver 80                             *< CPU frequency in MHz */
    ...
    #define EEL_POOL_START      (0u * EEL_VIRTUALBLOCKSIZE)  /*Not use EEL pool  (1u * EEL_VIRTUALBLOCKSIZE)     *< 1st block of the EEL pool */
    #define EEL_POOL_SIZE         (0u * EEL_VIRTUALBLOCKSIZE) /*Not use EEL pool   (6u * EEL_VIRTUALBLOCKSIZE)     *< no. of blocks for the EEL pool */     
